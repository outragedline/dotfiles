...
yay -S gammastep  swaybg

yay -S ttf-jetbrains-mono-nerd  ttf-noto-nerd noto-fonts-cjk noto-fonts-emoji noto-fonts-extra
...
yay -S okular qbittorrent ranger  64gram-desktop ungoogled-chromium-bin chromium-extension-web-store uget  mpv viewnior btop thunderbird zsh lazygit stow github-cli blender gimp discord kdenlive syncthing dust  bat obs-studio
