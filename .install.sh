...
yay -S okular qbittorrent ranger  64gram-desktop  mpv viewnior btop thunderbird zsh lazygit stow github-cli blender gimp discord kdenlive syncthing dust  bat obs-studio anytype-bin --noconfirm
