...
yay -S okular qbittorrent ranger  64gram-desktop librewolf-bin uget  mpv viewnior btop thunderbird zsh lazygit stow github-cli blender gimp discord kdenlive
