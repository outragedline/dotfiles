...
yay -S okular qbittorrent ranger ueberzugpp  telegram-desktop librewolf-bin uget  mpv viewnior btop thunderbird zsh lazygit stow github-cli blender gimp discord
